...
- **BLOG-01**: Blog section for content marketing
- **CMS-01**: Headless CMS integration for content editing
- **ANALYTICS-01**: Analytics dashboard integration
- **TESTIMONIALS-01**: Client testimonials section with social proof

## Out of Scope

| Feature | Reason |
|---------|--------|
| E-commerce/cart | Not needed — services are quote-based |
| Client portal | Simple contact form sufficient for v1 |
| Multi-language | English only for target market |
| Blog | Deferred to v2, not core to launch |
| CMS | Static content fine for v1, easier deployment |
